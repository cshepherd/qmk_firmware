...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_h7v3_183(
        ...
        H_LOCAL,           H_NETWORK,         H_SYSTEM,             H_REFRESH,           KC_F14,                KC_F15,                KC_KB_MUTE,                       KC_KB_VOLUME_DOWN,                KC_KB_VOLUME_UP,              H_REPEAT,          H_TRANSMIT,           H_STATUS,            H_SUSPEND,           KC_CAPS_LOCK,      //14
        ...
        KC_F3,   KC_F4,    KC_FIND,  H_WRITE, KC_LEAD,  H_DOUBLE_QUOTE__PLUS_MINUS, KC_GRAVE,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,    KC_6,     KC_7,    KC_8,     KC_9,    KC_0,     KC_MINS,  KC_EQL,  KC_BACKSLASH, H_L_BRACE__L_CHEVRON,  H_R_BRACE__R_CHEVRON,  KC_UNDO,    KC_TILD,   KC_PSLS,  KC_PAST,  KC_PMNS, //27
        ...
        KC_F7,   KC_F8,    KC_SELECT,H_DEBUG, MO(_FN), KC_NO,       MO(_APL), KC_A,     KC_S,     KC_D,     KC_F,     KC_G,    KC_H,     KC_J,    KC_K,     KC_L,    KC_SEMICOLON,  KC_QUOT,  KC_ENT , KC_ENT, H_PAGE,                                                           KC_P4,     KC_P5,    KC_P6,    KC_AMPR, //25
        KC_F9,   KC_F10,   H_TTY,    KC_LOCK, KC_HOME,  KC_END ,  MO(_GREEK), KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,    KC_B,     KC_N,    KC_M,     KC_COMM, KC_DOT,   KC_SLSH,  KC_RSFT, MO(_GREEK),KC_UP,    KC_END,                                                              KC_P1,     KC_P2,    KC_P3,    KC_PEQL,  //26
        KC_F11,  KC_F12,   KC_HOME,  H_EOF,   KC_MPRV,  KC_MNXT,  H_7BIT,  KC_LALT,  KC_HYPR,  KC_LGUI,  KC_LCTL,  KC_SPC,  KC_SPC,  KC_SPC,  KC_RCTL,  KC_RGUI, KC_HYPR,  KC_RGUI,  KC_LEFT, KC_DOWN, KC_RGHT,                                                                        KC_DEL,    KC_P0,    KC_PDOT,  KC_PENT //25
    ),
  ...
  if (record->event.pressed) {
    switch(keycode) {
      ...
      case H_SQUARE:
        ...
        return false;
      case H_STATUS:
        sprintf(wpm_str, "%3d wpm", get_current_wpm());
        send_string(wpm_str);
        return false;
      case H_TRIANGLE:
